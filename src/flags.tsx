...
const REGION_ALIASES: Record<string, string> = {
  argentina: "AR", america: "US", australia: "AU", austria: "AT", belgium: "BE",
  brazil: "BR", britain: "GB", canada: "CA", chile: "CL", china: "CN", cn: "CN",
  denmark: "DK", de: "DE", deutschland: "DE", europa: "EU", europe: "EU", france: "FR",
  germany: "DE", hk: "HK", hongkong: "HK", "hong kong": "HK", india: "IN",
  indonesia: "ID", ireland: "IE", israel: "IL", italy: "IT", japan: "JP",
  korea: "KR", malaysia: "MY", mexico: "MX", netherlands: "NL", norway: "NO",
  philippines: "PH", poland: "PL", portugal: "PT", russia: "RU", singapore: "SG",
  spain: "ES", sweden: "SE", switzerland: "CH", taiwan: "TW", thailand: "TH",
  turkey: "TR", uk: "GB", uae: "AE", "united arab emirates": "AE", unitedkingdom: "GB",
  unitedstates: "US", us: "US", usa: "US", vietnam: "VN",
  阿根廷: "AR", 奥地利: "AT", 比利时: "BE", 巴西: "BR", 中国: "CN",
  台湾: "TW", 香港: "HK", 澳门: "MO", 日本: "JP", 韩国: "KR",
  新加坡: "SG", 印度: "IN", 印尼: "ID", 印度尼西亚: "ID", 马来西亚: "MY",
  美国: "US", 英国: "GB", 德国: "DE", 法国: "FR", 加拿大: "CA",
  澳大利亚: "AU", 澳洲: "AU", 荷兰: "NL", 爱尔兰: "IE", 意大利: "IT",
  西班牙: "ES", 葡萄牙: "PT", 瑞典: "SE", 瑞士: "CH", 挪威: "NO",
  丹麦: "DK", 波兰: "PL", 俄罗斯: "RU", 土耳其: "TR", 泰国: "TH",
  越南: "VN", 菲律宾: "PH", 墨西哥: "MX", 智利: "CL", 以色列: "IL",
  阿联酋: "AE", 欧洲: "EU",
};
...
function countryCodeFromFlagEmoji(input: string): string | null {
  ...
  const valid = first >= REGIONAL_INDICATOR_MIN && first <= REGIONAL_INDICATOR_MAX &&
...
export function getCountryCode(region: string | null | undefined): string | null {
  ...
  const isValidToken = (token: string) => token === "UK" || ISO_3166_ALPHA2.has(token);
...
export function getDisplayRegionCode(region: string | null | undefined): string {
  return getCountryCode(region) ?? "UN";
}
